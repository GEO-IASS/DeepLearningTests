...
portion = 1;
validation = .2;
for hidden_layers = {[500,500,1000],[1500,2000,3000],[3000,4000,6000]}
    ...
    for lables = [.006,.01,.1,1]
        ...
        save(sprintf('%s [%d,%d,%d] lr=%g po=%g ep=%g mo=%g.mat','Results/Rectangles/NN'...
            ,gd_opts.layers(1),gd_opts.layers(2),gd_opts.layers(3),gd_opts.learning_rate...
            ,portion,gd_opts.epochs,gd_opts.momentum),'nn_res');
        ...
        save(sprintf('%s [%d,%d,%d] lr=%g po=%g ep=%g mo=%g.mat','Results/Rectangles/DBN_Post'...
            ,gd_opts.layers(1),gd_opts.layers(2),gd_opts.layers(3),gd_opts.learning_rate...
            ,portion,gd_opts.epochs,gd_opts.momentum),'dbn_res');
    end
end
%% Plot
plot_res(nns,dbns);